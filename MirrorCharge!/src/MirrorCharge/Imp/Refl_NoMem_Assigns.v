...
Local Existing Instance Imp.ILogic_HProp.
Local Existing Instance Imp.BILogicOps_HProp.
Local Existing Instance Imp.ILogicOps_SProp.
Local Existing Instance Imp.ILogic_SProp.
Local Existing Instance Imp.BILogicOps_SProp.
Local Existing Instance Imp.ILogicOps_lprop.
Local Existing Instance Imp.ILogic_lprop.
Local Existing Instance Imp.BILOps.
Local Existing Instance Imp.BILogic.
Local Existing Instance Imp.EmbedOp_Prop_HProp.
Local Existing Instance Imp.Embed_Prop_HProp.
Local Existing Instance Imp.EmbedOp_HProp_lprop.
Local Existing Instance Imp.Embed_HProp_lprop.
Local Existing Instance Imp.EmbedOp_Prop_SProp.
Local Existing Instance Imp.Embed_Prop_SProp.
...
Ltac finisher :=
  intros;
  eapply ILEmbed.embed_sound;
  compute; intros; subst;
  assumption.

Goal @ILogic.lentails Imp.SProp Imp.ILogicOps_SProp (@ILogic.ltrue Imp.SProp Imp.ILogicOps_SProp)
     (Imp.triple (fun l => ILEmbed.embed (Imp.locals_get "x"%string l = 0))
                 (adds 5)
                 (fun l => ILEmbed.embed (Imp.locals_get "x"%string l = 5))).
unfold adds.
Time the_solver.
Time finisher.
Time Qed.
...
Goal @ILogic.lentails Imp.SProp Imp.ILogicOps_SProp (@ILogic.ltrue Imp.SProp Imp.ILogicOps_SProp)
     (Imp.triple (fun l => ILEmbed.embed (Imp.locals_get "x"%string l = 0))
                 (adds 10)
                 (fun l => ILEmbed.embed (Imp.locals_get "x"%string l = 10))).
unfold adds.
Time the_solver.
Time finisher.
Time Qed.
...
Goal @ILogic.lentails Imp.SProp Imp.ILogicOps_SProp (@ILogic.ltrue Imp.SProp Imp.ILogicOps_SProp)
     (Imp.triple (fun l => ILEmbed.embed (Imp.locals_get "x"%string l = 0))
                 (adds 15)
                 (fun l => ILEmbed.embed (Imp.locals_get "x"%string l = 15))).
unfold adds.
Time the_solver.
Time finisher.
Time Qed.
...
Goal @ILogic.lentails Imp.SProp Imp.ILogicOps_SProp (@ILogic.ltrue Imp.SProp Imp.ILogicOps_SProp)
     (Imp.triple (fun l => ILEmbed.embed (Imp.locals_get "x"%string l = 0))
                 (adds 20)
                 (fun l => ILEmbed.embed (Imp.locals_get "x"%string l = 20))).
unfold adds.
Time the_solver.
Time finisher.
Time Qed.
